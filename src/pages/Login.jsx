...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      Cookies.set("userId", myId, { expires: 1});
  ...
  return (
    <>
      <div className="w-full h-screen flex justify-center items-center">
        <ToastContainer />
        <div className="w-90 rounded-lg shadow h-[380px] p-6 bg-white relative overflow-hidden">
          ...
          <form onSubmit={handleLogin} className="w-full mt-4 space-y-8 ">
            ...
            {loader ? (
              <div className="w-full text-center py-1 bg-blue-500 hover:bg-blue-600 active:bg-blue-700 rounded-md text-white ring-2">
                <ClipLoader size={20} />
              </div>
            ) : (
              <button
